...
The repository carries a **`war_parche.ips`** of 487 bytes. It holds only the
bytes that change — our own code, the drawing of the Eye of Sauron and the new
text — and it
